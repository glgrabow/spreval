...
```
or you may navigate to the [github repository page](https://github.com/glgrabow/spreval) and click under 
"releases" to download the source code and install locally.  
